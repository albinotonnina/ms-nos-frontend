module.exports = function (grunt) {
    ...
    grunt.registerTask('buildRequirejsConfig', function () {
        grunt.file.write(path.join(os.tmpdir(), 'frontend_require.js'), 'var require = ' + buildRequirejsConfig() + ';');
    });
    ...
    grunt.registerTask('development', ['less', 'cssmin', 'copy:development', 'buildTemplates']);
    grunt.registerTask('production', ['less', 'cssmin', 'copy:production', 'buildRequirejsConfig', 'requirejs', 'buildTemplates']);
